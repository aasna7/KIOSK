...
public class Seedetails extends javax.swing.JFrame {
 ...
 Events eve= new Events();
        String event_no1= eve.event_no;
    /**
     * Creates new form Seedetails
     */
    public Seedetails() {
        initComponents();
        setDefaultCloseOperation(Seedetails.DISPOSE_ON_CLOSE);
        show_details();
    ...
    public void show_details()
    {
        ...
        System.out.println("if statement");
            ...
            imagesee.setIcon(new ImageIcon(image.getScaledInstance(175,208,Image.SCALE_SMOOTH)));
            }
...
catch(Exception e)
{
    ...
    private void initComponents() {
        ...
        eventnamesee.setBounds(320, 130, 130, 20);
